...
async function captureMoodWithAI() {
    ...
    try {
        ...
        setTimeout(() => {
            ...
            // Map expression to mood text
            let moodText = 'I feel good';
            if(maxEmotion === 'happy') moodText = 'I feel happy';
            else if(maxEmotion === 'sad') moodText = 'I feel sad';
            else if(maxEmotion === 'neutral') moodText = 'I feel neutral';
            else if(maxEmotion === 'angry') moodText = 'I feel angry';
            else if(maxEmotion === 'fearful') moodText = 'I feel anxious';
            else if(maxEmotion === 'disgusted') moodText = 'I feel disgusted';
            else if(maxEmotion === 'surprised') moodText = 'I feel surprised';
            
            // Auto-fill the input
            input.value = moodText;
            
            // Auto-start playlist generation
            generateMelody();
        }, 1000);
    } catch(e) { 
        stopCamera(); 
        overlay.remove(); 
        alert("AI Error: Could not analyze face."); 
    }
}